...
<form action="{{ route('editAdm') }}" method="post" enctype="multipart/form-data">
                        @csrf
    <div class="overlay">
        <div class="container">
            <div class="row">                
                    ...
                    <div class="col">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-12 text-center">
                                <p >Edit Profil</p>
                                @if($dataUser->guru->foto)
                                <img id="previewImage" src="{{ asset('storage/foto/' . $dataUser->guru->foto) }}" alt="Default Foto Profil" style="margin-top: 20px; object-fit: cover; width: 100px; height: 100px; object-position: center top;" class="img-fluid img-thumbnail">
                                @else
