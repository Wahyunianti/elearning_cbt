            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="main-content">
                        <h1>الدَّرْسُ الرَّابِعُ</h1>
                        <div class="breadcrumb-area">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb d-flex justify-content-center">
                                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Bab 4</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<section id="tournaments-content">
    <div class="container pb-120">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <h4 class="head-area" style="text-align:center;">Alamat (الْعُنْوَانُ)</h4>
                ...
                <div class="info-area">
                    <div class="single-info">
                        <p>Pada proses pembelajaran kali ini kita akan belajar tentang topik alamat dalam
                            Bahasa Arab.
                            Pernahkan kalian menyebutkan alamat seseorang dengan
...
kalian ketahui, apakah kalian sudah tahu mufrodat tentang lokasi alamat ? apakah kalian bisa memberikan contoh kata tersebut dalam
kalimat?. Apakan kalian tahu struktur kata dalam kalimat bahasa arab yang
menggunakan mufrodat tentang alamat ? Tanpa
mengetahui itu semua tentu sangatlah sulit untuk kalian memahami bahasa arab. Untuk itu simak baik baik pembelajaran yang disampaikan ya semuanya.
                    ...
                    <div class="single-info">
                        ...
                        <p>Berikut ini akan dijelaskan arti dan kosa kata seputar alamat.
                        </p><br>
                        <h5>Judul (الْمُفْرَدَاتِ عَنِ الْعُنْوَانِ)</h5>
                        <div class="row">
                            <div class="col-lg-5 col-md-5 col-sm-5  mx-auto">
                                <img src="img/bab4/1.png" alt="image3" class="mx-auto d-block">
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-5  mx-auto">
                                <img src="img/bab4/2.png" alt="image3" class="mx-auto d-block">
                            </div>
                        </div><br>                       
                    </div>
